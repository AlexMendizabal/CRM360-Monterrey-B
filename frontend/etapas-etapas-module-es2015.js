...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsEtapasCadastroComponent", function() { return LogisticaYmsEtapasCadastroComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_cadastro_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./cadastro.component.html */ "FfNJ");
/* harmony import */ var _cadastro_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cadastro.component.scss */ "0HNB");
...
/* harmony import */ var _setores_services_setores_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../setores/services/setores.service */ "vpXL");
...
/* harmony import */ var _services_etapas_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../services/etapas.service */ "Tp9O");
...
let LogisticaYmsEtapasCadastroComponent = class LogisticaYmsEtapasCadastroComponent {
    constructor(formBuilder, pnotify, activatedRoute, router, localeService, etapasService, titleService, atividadesService, tiposEtapaService, setoresService) {
...
LogisticaYmsEtapasCadastroComponent.ctorParameters = () => [
...
LogisticaYmsEtapasCadastroComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormBuilder"],
        ...
        _setores_services_setores_service__WEBPACK_IMPORTED_MODULE_4__["LogisticaYmsSetoresService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsEtapasAssociacaoSetoresComponent", function() { return LogisticaYmsEtapasAssociacaoSetoresComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_associacao_setores_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./associacao-setores.component.html */ "+wCn");
/* harmony import */ var _associacao_setores_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./associacao-setores.component.scss */ "Cft5");
...
/* harmony import */ var _services_etapas_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/etapas.service */ "Tp9O");
...
let LogisticaYmsEtapasAssociacaoSetoresComponent = class LogisticaYmsEtapasAssociacaoSetoresComponent {
    constructor(formBuilder, etapasService, pnotify, activatedRoute, atividadesService, confirmModalService, setoresService, tiposSetorService, filiaisService) {
        this.formBuilder = formBuilder;
        this.etapasService = etapasService;
        this.pnotify = pnotify;
        this.activatedRoute = activatedRoute;
    ...
    onActivatedRoute() {
        ...
        this.getSetoresAssociados({ "UUID_LOGI_YMS_ETAP": params === null || params === void 0 ? void 0 : params.id });
    }
    setBreadCrumb() {
        const id = this.activatedRoute.snapshot.params.idSubModulo;
        this.breadCrumbTree = [
    ...
    getSetores() {
        var _a;
        let params = (_a = {}) !== null && _a !== void 0 ? _a : this.formSetores.value;
        params.IN_STAT = 1;
        params.IN_PAGI = 0;
    ...
    onAssociarSetores() {
        ...
        setores.map(item => {
            var _a, _b, _c;
            item.loading = true;
            if (this.setoresAssociados.some(setor => (setor === null || setor === void 0 ? void 0 : setor.UUID_LOGI_YMS_SETO) === item.UUID_LOGI_YMS_SETO)) {
                return;
            }
            let params = {
                "UUID_LOGI_YMS_ETAP": (_a = this.form.get("UUID_LOGI_YMS_ETAP").value) !== null && _a !== void 0 ? _a : "",
            ...
            this.etapasService
                ...
                .subscribe(response => {
                if (response.status === 200) {
                    this.setoresAssociados = [...this.setoresAssociados, Object.assign(Object.assign({}, item), { checked: false, NR_SQNC: item.NR_SQNC, NM_SETO: item.NM_SETO, NM_FILI: item.NM_FILI, NM_SETO_TIPO: item.NM_SETO_TIPO, loading: false, UUID_LOGI_YMS_SETO: item.UUID_LOGI_YMS_SETO, UUID_LOGI_YMS_ETAP: this.form.get('UUID_LOGI_YMS_ETAP').value })];
...
LogisticaYmsEtapasAssociacaoSetoresComponent.ctorParameters = () => [
...
LogisticaYmsEtapasAssociacaoSetoresComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormBuilder"],
        _services_etapas_service__WEBPACK_IMPORTED_MODULE_9__["LogisticaYmsEtapasService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsEtapasModule", function() { return LogisticaYmsEtapasModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
...
/* harmony import */ var _lista_lista_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./lista/lista.component */ "wVov");
/* harmony import */ var _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./cadastro/cadastro.component */ "KwSx");
/* harmony import */ var _etapas_routing_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./etapas-routing.module */ "kuaD");
/* harmony import */ var _associacao_setores_associacao_setores_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./associacao-setores/associacao-setores.component */ "TGEt");
...
let LogisticaYmsEtapasModule = class LogisticaYmsEtapasModule {
};
LogisticaYmsEtapasModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _lista_lista_component__WEBPACK_IMPORTED_MODULE_12__["LogisticaYmsEtapasListaComponent"],
            _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_13__["LogisticaYmsEtapasCadastroComponent"],
            _associacao_setores_associacao_setores_component__WEBPACK_IMPORTED_MODULE_15__["LogisticaYmsEtapasAssociacaoSetoresComponent"]
        ],
        imports: [
            ...
            _etapas_routing_module__WEBPACK_IMPORTED_MODULE_14__["LogisticaYmsEtapasRoutingModule"]
        ]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsEtapasRoutingModule", function() { return LogisticaYmsEtapasRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _associacao_setores_associacao_setores_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./associacao-setores/associacao-setores.component */ "TGEt");
...
/* harmony import */ var _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cadastro/cadastro.component */ "KwSx");
/* harmony import */ var _lista_lista_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./lista/lista.component */ "wVov");
...
let LogisticaYmsEtapasRoutingModule = class LogisticaYmsEtapasRoutingModule {
};
LogisticaYmsEtapasRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsEtapasListaComponent", function() { return LogisticaYmsEtapasListaComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_lista_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./lista.component.html */ "IZqw");
/* harmony import */ var _lista_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lista.component.scss */ "6mhV");
/* harmony import */ var _setores_services_setores_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../setores/services/setores.service */ "vpXL");
/* harmony import */ var _circuitos_services_circuitos_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../circuitos/services/circuitos.service */ "yw/Z");
...
/* harmony import */ var _services_etapas_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../services/etapas.service */ "Tp9O");
...
let LogisticaYmsEtapasListaComponent = class LogisticaYmsEtapasListaComponent {
    /* Pagination */
    constructor(route, pnotify, formBuilder, xlsxService, dateService, routerService, activatedRoute, detailPanelService, confirmModalService, etapasService, circuitosService, setoresService) {
        this.route = route;
        this.pnotify = pnotify;
        this.formBuilder = formBuilder;
...
LogisticaYmsEtapasListaComponent.ctorParameters = () => [
...
LogisticaYmsEtapasListaComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"],
        ...
        _services_etapas_service__WEBPACK_IMPORTED_MODULE_11__["LogisticaYmsEtapasService"],
        _circuitos_services_circuitos_service__WEBPACK_IMPORTED_MODULE_4__["LogisticaYmsCircuitosService"],
        _setores_services_setores_service__WEBPACK_IMPORTED_MODULE_3__["LogisticaYmsSetoresService"]])
...
//# sourceMappingURL=etapas-etapas-module-es2015.js.map