...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsAssociacaoMateriaisService", function() { return LogisticaYmsAssociacaoMateriaisService; });
...
let LogisticaYmsAssociacaoMateriaisService = class LogisticaYmsAssociacaoMateriaisService {
    constructor(http) {
        this.http = http;
    ...
    postAssociacaoMateriais(associacao) {
        return this.http.post(`${this.API}/logistica/yms/setores/materiais`, associacao, {
            observe: 'response',
        });
    }
};
LogisticaYmsAssociacaoMateriaisService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
LogisticaYmsAssociacaoMateriaisService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root',
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])
], LogisticaYmsAssociacaoMateriaisService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsAssociacaoMateriaisCadastroComponent", function() { return LogisticaYmsAssociacaoMateriaisCadastroComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_cadastro_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./cadastro.component.html */ "SqrX");
/* harmony import */ var _cadastro_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cadastro.component.scss */ "MgIp");
...
/* harmony import */ var _setores_services_setores_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../../setores/services/setores.service */ "vpXL");
/* harmony import */ var _services_associacao_materiais_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/associacao-materiais.service */ "+YLw");
...
let LogisticaYmsAssociacaoMateriaisCadastroComponent = class LogisticaYmsAssociacaoMateriaisCadastroComponent {
    /* Pagination */
    constructor(pnotify, formBuilder, titleService, activatedRoute, localeService, atividadesService, setoresService, tiposSetorService, confirmModalService, associacaoMateriaisService) {
    ...
    onLimparAssociacoes() {
        this.confirmDelete().subscribe((response) => response ? this.deleteAssociacoes(this.form.get('UUID_LOGI_YMS_SETO').value) : null);
    }
    deleteAssociacoes(params) {
    ...
    onDeleteMaterial(material) {
        this.confirmDelete().subscribe((response) => response ? this.deleteMaterial(material) : null);
    }
    confirmDelete() {
        ...
        if (this.formMateriais.valid) {
            ...
            this.associacaoMateriaisService
                ...
                if (response.status === 200) {
                    ...
                    this.materiaisLista = response.body['result'].map(function (el) {
    ...
    onAddMaterial(material) {
        ...
        this.postAssociacaoMateriais(Object.assign(Object.assign({}, material), { IN_STAT: 1 }));
    }
    checkMaterialExists(lista, material) {
        return lista.some((materialAssociado) => {
...
LogisticaYmsAssociacaoMateriaisCadastroComponent.ctorParameters = () => [
...
LogisticaYmsAssociacaoMateriaisCadastroComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_shared_services_core_pnotify_service__WEBPACK_IMPORTED_MODULE_5__["PNotifyService"],
        ...
        _setores_services_setores_service__WEBPACK_IMPORTED_MODULE_8__["LogisticaYmsSetoresService"],
        ...
        _services_associacao_materiais_service__WEBPACK_IMPORTED_MODULE_9__["LogisticaYmsAssociacaoMateriaisService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsAssociacaoMateriaisListaComponent", function() { return LogisticaYmsAssociacaoMateriaisListaComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_lista_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./lista.component.html */ "eC/F");
/* harmony import */ var _lista_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lista.component.scss */ "ATYN");
...
/* harmony import */ var _setores_services_setores_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./../../setores/services/setores.service */ "vpXL");
/* harmony import */ var _services_associacao_materiais_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/associacao-materiais.service */ "+YLw");
...
let LogisticaYmsAssociacaoMateriaisListaComponent = class LogisticaYmsAssociacaoMateriaisListaComponent {
    /* Pagination */
    constructor(route, pnotify, formBuilder, xlsxService, dateService, routerService, activatedRoute, setoresService, detailPanelService, associacaoMateriaisService) {
        this.route = route;
        this.pnotify = pnotify;
        this.formBuilder = formBuilder;
...
LogisticaYmsAssociacaoMateriaisListaComponent.ctorParameters = () => [
...
LogisticaYmsAssociacaoMateriaisListaComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
        ...
        _setores_services_setores_service__WEBPACK_IMPORTED_MODULE_11__["LogisticaYmsSetoresService"],
        _shared_templates_detail_panel_detal_panel_service__WEBPACK_IMPORTED_MODULE_10__["DetailPanelService"],
        _services_associacao_materiais_service__WEBPACK_IMPORTED_MODULE_12__["LogisticaYmsAssociacaoMateriaisService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsAssociacaoMateriaisRoutingModule", function() { return LogisticaYmsAssociacaoMateriaisRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
...
/* harmony import */ var _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cadastro/cadastro.component */ "93xu");
/* harmony import */ var _lista_lista_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lista/lista.component */ "FArF");
...
let LogisticaYmsAssociacaoMateriaisRoutingModule = class LogisticaYmsAssociacaoMateriaisRoutingModule {
};
LogisticaYmsAssociacaoMateriaisRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogisticaYmsAssociacaoMateriaisModule", function() { return LogisticaYmsAssociacaoMateriaisModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
...
/* harmony import */ var _lista_lista_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./lista/lista.component */ "FArF");
/* harmony import */ var _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./cadastro/cadastro.component */ "93xu");
/* harmony import */ var _associacao_materiais_routing_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./associacao-materiais-routing.module */ "SKcO");
...
let LogisticaYmsAssociacaoMateriaisModule = class LogisticaYmsAssociacaoMateriaisModule {
};
LogisticaYmsAssociacaoMateriaisModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _lista_lista_component__WEBPACK_IMPORTED_MODULE_12__["LogisticaYmsAssociacaoMateriaisListaComponent"],
            _cadastro_cadastro_component__WEBPACK_IMPORTED_MODULE_13__["LogisticaYmsAssociacaoMateriaisCadastroComponent"]
        ],
        imports: [
            ...
            _associacao_materiais_routing_module__WEBPACK_IMPORTED_MODULE_14__["LogisticaYmsAssociacaoMateriaisRoutingModule"]
        ]
    })
...
//# sourceMappingURL=associacao-materiais-associacao-materiais-module-es2015.js.map