(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tipo-produto-tipo-produto-module"], {
    ...
    /***/
    function bx8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Fkn6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoEstoqueTipoProdutosModuleRoutingModule", function () {
        return TecnologiaInformacaoEstoqueTipoProdutosModuleRoutingModule;
      });
      /* harmony import */
      ...
      var TecnologiaInformacaoEstoqueTipoProdutosModuleRoutingModule = /*#__PURE__*/_createClass(function TecnologiaInformacaoEstoqueTipoProdutosModuleRoutingModule() {
        _classCallCheck(this, TecnologiaInformacaoEstoqueTipoProdutosModuleRoutingModule);
      });

      TecnologiaInformacaoEstoqueTipoProdutosModuleRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function Iwnq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Ratu(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoEstoqueTipoProdutosCadastroComponent", function () {
        return TecnologiaInformacaoEstoqueTipoProdutosCadastroComponent;
      });
      /* harmony import */
      ...
      var _services_tipo_produto_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../services/tipo-produto.service */
      "U2E5");
      /* harmony import */
      ...
      var TecnologiaInformacaoEstoqueTipoProdutosCadastroComponent = /*#__PURE__*/function () {
        function TecnologiaInformacaoEstoqueTipoProdutosCadastroComponent(formBuilder, pnotify, activatedRoute, router, routerService, titleService, atividadesService, tipoProdutoService) {
          _classCallCheck(this, TecnologiaInformacaoEstoqueTipoProdutosCadastroComponent);
        ...
        _createClass(TecnologiaInformacaoEstoqueTipoProdutosCadastroComponent, [{
          key: "ngOnInit",
          ...
          value: function onActivatedRoute() {
            ...
            this.$activatedRouteSubscription = this.activatedRoute.params.subscribe(function (response) {
              if (response.hasOwnProperty('id')) {
                _this.getTipoProduto(response.id);
              }
            });
          } //formulario
          ...
          value: function getTipoProduto(id) {
            ...
            this.loading = true;
            this.tipoProdutoService.getTipoProduto(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () {
              ...
              var tipoProduto = response.body["data"];

              _this2.form.patchValue(tipoProduto);
            }, function (error) {
              try {
          ...
          key: "postTipoProduto",
          value: function postTipoProduto() {
            var _this3 = this;

            this.loadingNavBar = true;
            this.tipoProdutoService.postTipoProduto(this.form.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () {
      ...
      TecnologiaInformacaoEstoqueTipoProdutosCadastroComponent.ctorParameters = function () {
        return [{
    ...
    /***/
    function UWdo(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function hkZf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoEstoqueTipoProdutosModule", function () {
        return TecnologiaInformacaoEstoqueTipoProdutosModule;
      });
      /* harmony import */
      ...
      var _tipo_produto_routing_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./tipo-produto-routing.module */
      "Fkn6");
      /* harmony import */
    ...
    /***/
    function oGH1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function vQZ(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoEstoqueTipoProdutosListaComponent", function () {
        return TecnologiaInformacaoEstoqueTipoProdutosListaComponent;
      });
      /* harmony import */
      ...
      var _services_tipo_produto_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../services/tipo-produto.service */
      "U2E5");
      /* harmony import */
      ...
      var TecnologiaInformacaoEstoqueTipoProdutosListaComponent = /*#__PURE__*/function () {
        /* Pagination */
        function TecnologiaInformacaoEstoqueTipoProdutosListaComponent(route, pnotify, activatedRoute, tipoProdutoService, formBuilder, confirmModalService, routerService, dateService) {
          _classCallCheck(this, TecnologiaInformacaoEstoqueTipoProdutosListaComponent);
        ...
        _createClass(TecnologiaInformacaoEstoqueTipoProdutosListaComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.buildForm();
            this.setBreadCrumb();
          ...
          value: function onActivatedRoute() {
            ...
            this.$activatedRouteSubscription = this.activatedRoute.queryParams.subscribe(function (response) {
              ...
              _this4.getTiposProduto(_this4.getParams());
            });
          }
        }, {
          ...
          value: function getTiposProduto(params) {
            ...
            this.tipoProdutoService.getTiposProduto(params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["finalize"])(function () {
              _this5.loading = false;
              _this5.loadingNavBar = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this5.tipoProdutos = response.body['data'];
          ...
          key: "changeType",
          value: function changeType(tipoProduto) {
            var _this6 = this;

            var stat = tipoProduto.IN_STAT == '1' ? '0' : '1';
            this.confirmChange(stat).asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["switchMap"])(function (result) {
              ...
              return _this6.tipoProdutoService.postTipoProduto(tipoProduto);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["finalize"])(function () {
              _this6.loadingNavBar = false;
            })).subscribe(function (success) {
              _this6.pnotify.success(); //tipoContrato.IN_STAT = stat;
      ...
      TecnologiaInformacaoEstoqueTipoProdutosListaComponent.ctorParameters = function () {
        return [{
      ...
      TecnologiaInformacaoEstoqueTipoProdutosListaComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        selector: 'tecnologia-informacao-estoque-tipo-produto-lista',
        template: _raw_loader_lista_component_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: [_lista_component_scss__WEBPACK_IMPORTED_MODULE_2__["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], src_app_shared_services_core_pnotify_service__WEBPACK_IMPORTED_MODULE_7__["PNotifyService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"], _services_tipo_produto_service__WEBPACK_IMPORTED_MODULE_8__["TecnologiaInformacaoEstoqueTipoProdutosService"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"], _shared_modules_confirm_modal_confirm_modal_service__WEBPACK_IMPORTED_MODULE_3__["ConfirmModalService"], src_app_shared_services_core_router_service__WEBPACK_IMPORTED_MODULE_9__["RouterService"], src_app_shared_services_core_date_service__WEBPACK_IMPORTED_MODULE_12__["DateService"]])], TecnologiaInformacaoEstoqueTipoProdutosListaComponent);
      /***/
    }
  }]);
})();
//# sourceMappingURL=tipo-produto-tipo-produto-module-es5.js.map