(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modelo-modelo-module~produtos-produtos-module"], {
    /***/
    "5yQK":
    /*!*****************************************************************************************!*\
      !*** ./src/app/modules/tecnologia-informacao/estoque/modelo/services/modelo.service.ts ***!
      \*****************************************************************************************/

    /*! exports provided: TecnologiaInformacaoEstoqueModeloService */

    /***/
    function yQK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoEstoqueModeloService", function () {
        return TecnologiaInformacaoEstoqueModeloService;
      });
      /* harmony import */
      ...
      var TecnologiaInformacaoEstoqueModeloService = /*#__PURE__*/function () {
        function TecnologiaInformacaoEstoqueModeloService(http) {
          _classCallCheck(this, TecnologiaInformacaoEstoqueModeloService);

          this.http = http;
          this.API = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].API;
        }

        _createClass(TecnologiaInformacaoEstoqueModeloService, [{
          key: "getModelos",
          value: function getModelos(params) {
            return this.http.get("".concat(this.API, "/tecnologia-informacao/estoque/produtos/modelos"), {
              params: params,
              observe: 'response'
            });
          }
          ...
          value: function getModelo(id) {
            return this.http.get("".concat(this.API, "/tecnologia-informacao/estoque/produtos/modelos/").concat(id), {
              observe: 'response'
            });
          }
        }, {
          ...
          value: function postModelo(modelo) {
            return this.http.post("".concat(this.API, "/tecnologia-informacao/estoque/produtos/modelos"), modelo, {
              observe: 'response'
            });
          }
        }]);
      ...
      TecnologiaInformacaoEstoqueModeloService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]
        }];
      };

      TecnologiaInformacaoEstoqueModeloService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])], TecnologiaInformacaoEstoqueModeloService);
      /***/
    },
...
//# sourceMappingURL=default~modelo-modelo-module~produtos-produtos-module-es5.js.map