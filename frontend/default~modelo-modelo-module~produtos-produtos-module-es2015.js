...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoEstoqueModeloService", function() { return TecnologiaInformacaoEstoqueModeloService; });
...
let TecnologiaInformacaoEstoqueModeloService = class TecnologiaInformacaoEstoqueModeloService {
    constructor(http) {
        this.http = http;
        this.API = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].API;
    }
    getModelos(params) {
        return this.http.get(`${this.API}/tecnologia-informacao/estoque/produtos/modelos`, {
            params: params,
            observe: 'response',
        });
    }
    getModelo(id) {
        return this.http.get(`${this.API}/tecnologia-informacao/estoque/produtos/modelos/${id}`, {
            observe: 'response',
        });
    }
    postModelo(modelo) {
        return this.http.post(`${this.API}/tecnologia-informacao/estoque/produtos/modelos`, modelo, {
            observe: 'response',
        });
    }
};
TecnologiaInformacaoEstoqueModeloService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
TecnologiaInformacaoEstoqueModeloService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=default~modelo-modelo-module~produtos-produtos-module-es2015.js.map