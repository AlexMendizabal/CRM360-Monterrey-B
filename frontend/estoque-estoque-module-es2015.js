...
let ComercialEstoqueListaComponent = class ComercialEstoqueListaComponent {
    ...
    onPageChangeSuspenso(event) {
        //console.log(event)
        this.currentPageSuspenso = event.page;
        this.getPaginateDataComprometido();
    }
    getPaginateDatSuspenso() {
    ...
    onGetEstoqueAlmacen() {
        ...
        this.estoqueService.getStockAlmacenes(params).subscribe((response) => {
