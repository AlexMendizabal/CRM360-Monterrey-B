(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["item-item-module"], {
    ...
    /***/
    function rmI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoItemModule", function () {
        return TecnologiaInformacaoItemModule;
      });
      /* harmony import */
      ...
      var _item_routing_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./item-routing.module */
      "bb1x");
      /* harmony import */
    ...
    function zXH(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoCadastrosItemCadastroComponent", function () {
        return TecnologiaInformacaoCadastrosItemCadastroComponent;
      });
      /* harmony import */
      ...
      var _estoque_movimentacoes_services_movimentacoes_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./../../../estoque/movimentacoes/services/movimentacoes.service */
      "3vpR");
      /* harmony import */


      var _estoque_services_estoque_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./../../../estoque/services/estoque.service */
      "vqwq");
      /* harmony import */
      ...
      var _contrato_services_contrato_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./../../contrato/services/contrato.service */
      "Ztrz");
      /* harmony import */
      ...
      var TecnologiaInformacaoCadastrosItemCadastroComponent = /*#__PURE__*/function () {
        // tipoMoeda = [];
        function TecnologiaInformacaoCadastrosItemCadastroComponent(formBuilder, pnotify, activatedRoute, confirmModalService, modalService, titleService, estoqueService, atividadesService, itemService, funcionarioService, contratos, movimentacoesService, router) {
          _classCallCheck(this, TecnologiaInformacaoCadastrosItemCadastroComponent);
        ...
        _createClass(TecnologiaInformacaoCadastrosItemCadastroComponent, [{
          key: "ngOnInit",
          ...
          value: function getEstoqueItens(params) {
            ...
            this.estoqueService.getEstoqueItens(_params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["finalize"])(function () {
              _this.loadingProduto = false;
          ...
          value: function getContrato(params) {
            ...
            this.contratos.getContrato(_params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["finalize"])(function () {
              _this2.loadingContrato = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this2.contrato = response.body['data'];
              } else {
                _this2.contrato = [];
              }
            }, function (error) {
          ...
          value: function getCentroCusto(params) {
            ...
            this.funcionarioService.getCentroCusto().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["finalize"])(function () {
              _this3.loadingCcu = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this3.centroCusto = response.body['data'];
              }
            });
          }
        }, {
          ...
          value: function getItem(params) {
            ...
            this.loading = true;
            this.itemService.getItem(params).subscribe(function (response) {
              if (response.status === 200) {
                _this4.loading = false;
                var _items = response.body['data'][0];

                _this4.form.patchValue(_items);

                _this4.formPesquisaItem.patchValue({
          ...
          value: function getItens() {
            ...
            this.itemService.getItem(_params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["finalize"])(function () {
              _this5.loadingItens = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this5.itens = response.body['data'];
              } else {
          ...
          key: "getFuncionarios",
          value: function getFuncionarios(params) {
            var _this6 = this;

            var _obj = this.formPesquisaFuncionario.value;
            ...
            this.funcionarioService.getFuncionario(_params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["finalize"])(function () {
              _this6.loadingFuncionario = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this6.funcionarios = response.body['data'];
              } else {
          ...
          key: "setFuncionario",
          value: function setFuncionario(funcionario) {
          ...
          value: function postMovimentacoes() {
            ...
            this.movimentacoesService.postMovimentacoes(Object.assign(Object.assign({}, params), {
              TP_MOVI: 'SAIDA',
              TT_PROD: 1
            })).subscribe(function (response) {
              if (response.status === 200) {
          ...
          value: function postItem() {
            ...
            this.loadingNavBar = true;
            var params = JSON.parse(JSON.stringify(this.form.getRawValue()));
            this.itemService.postItem(params).subscribe(function (response) {
              if (response.status === 200) {
                var _id = response.body['data']['message'];

                _this8.postDocumentos(_id);

                _this8.pnotify.success();
              } else {
                _this8.movimentacoesService.postMovimentacoes(Object.assign(Object.assign({}, params), {
                  TP_MOVI: 'ENTRADA',
                  TT_PROD: 1
                }));

                _this8.pnotify.error('Nenhuma Movimentação foi realizada!');
              }
            }, function (error) {
          ...
          key: "setNumeroSerie",
          value: function setNumeroSerie(event) {
            console.log(event);
            var cod = event === null || event === void 0 ? void 0 : event.CD_ITEM;
            var codEmpr = event === null || event === void 0 ? void 0 : event.ID_EMPR;
          ...
          value: function postDocumentos(id) {
            ...
            this.formData.forEach(function (element, index) {
              req.push(_this9.itemService.postDocumento(element, id));
            });
            Object(rxjs__WEBPACK_IMPORTED_MODULE_18__["forkJoin"])(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["finalize"])(function () {
              _this9.loadingNavBar = false;
            })).subscribe(function (response) {
              _this9.documentos = [];
              _this9.formData = [];

              _this9.pnotify.success("Documentos salvos com sucesso");
              ...
              _this9.pnotify.error('Erro ao salvar documentos');
            });
          }
        }, {
          key: "putDocumento",
          value: function putDocumento(documento) {
            ...
            var type = 'inactivate',
                ...
                cancelTxt = 'Cancelar',
                okTxt = 'Confirmar';
            this.confirmModalService.showConfirm(type, title, message, cancelTxt, okTxt).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["switchMap"])(function (result) {
              if (!result) return rxjs__WEBPACK_IMPORTED_MODULE_18__["EMPTY"];
              _this10.loadingNavBar = true;
              return _this10.itemService.putDocumento(documento);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["finalize"])(function () {
              _this10.loadingNavBar = false;
            })).subscribe(function (response) {
              _this10.pnotify.success('Documento atualizado com sucesso');

              _this10.getDocumentos({
                ID_TECN_INFO_ITEM: _this10.form.get('ID_TECN_INFO_ITEM').value,
                IN_STAT: '1'
              });
            });
          }
          ...
          value: function getDocumentos(params) {
            ...
            this.itemService.getDocumento(params).subscribe(function (response) {
              if (response.status === 200) {
                _this11.documentos = response.body['data'];
              } else {
                _this11.documentos = [];
              }
            }, function (error) {
      ...
      TecnologiaInformacaoCadastrosItemCadastroComponent.ctorParameters = function () {
        return [{
      ...
      TecnologiaInformacaoCadastrosItemCadastroComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_15__["Component"])({
        selector: 'tecnologia-informacao-cadastros-item-cadastro',
        template: _raw_loader_cadastro_component_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: [_cadastro_component_scss__WEBPACK_IMPORTED_MODULE_2__["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_16__["FormBuilder"], src_app_shared_services_core_pnotify_service__WEBPACK_IMPORTED_MODULE_12__["PNotifyService"], _angular_router__WEBPACK_IMPORTED_MODULE_14__["ActivatedRoute"], src_app_shared_modules_confirm_modal_confirm_modal_service__WEBPACK_IMPORTED_MODULE_8__["ConfirmModalService"], ngx_bootstrap__WEBPACK_IMPORTED_MODULE_13__["BsModalService"], src_app_shared_services_core_title_service__WEBPACK_IMPORTED_MODULE_9__["TitleService"], _estoque_services_estoque_service__WEBPACK_IMPORTED_MODULE_4__["TecnologiaInformacaoEstoqueService"], src_app_shared_services_requests_atividades_service__WEBPACK_IMPORTED_MODULE_10__["AtividadesService"], _services_item_service__WEBPACK_IMPORTED_MODULE_11__["TecnologiaInformacaoCadastroItemService"], _services_funcionarios_service__WEBPACK_IMPORTED_MODULE_5__["TecnologiaInformacaoFuncionariosService"], _contrato_services_contrato_service__WEBPACK_IMPORTED_MODULE_6__["TecnologiaInformacaoCadastroContratoService"], _estoque_movimentacoes_services_movimentacoes_service__WEBPACK_IMPORTED_MODULE_3__["TecnologiaInformacaoEstoqueMovimentacoesService"], _angular_router__WEBPACK_IMPORTED_MODULE_14__["Router"]])], TecnologiaInformacaoCadastrosItemCadastroComponent);
      /***/
    },
    ...
    /***/
    function WOC4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function bb1x(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoCadastrosItemModuleRoutingModule", function () {
        return TecnologiaInformacaoCadastrosItemModuleRoutingModule;
      });
      /* harmony import */
      ...
      var TecnologiaInformacaoCadastrosItemModuleRoutingModule = /*#__PURE__*/_createClass(function TecnologiaInformacaoCadastrosItemModuleRoutingModule() {
        _classCallCheck(this, TecnologiaInformacaoCadastrosItemModuleRoutingModule);
      });

      TecnologiaInformacaoCadastrosItemModuleRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function bhCr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function lH7e(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function oNPu(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TecnologiaInformacaoCadastrosItemListaComponent", function () {
        return TecnologiaInformacaoCadastrosItemListaComponent;
      });
      /* harmony import */
      ...
      var _shared_templates_detail_panel_detal_panel_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var TecnologiaInformacaoCadastrosItemListaComponent = /*#__PURE__*/function () {
        /* Pagination */
        function TecnologiaInformacaoCadastrosItemListaComponent(route, pnotify, activatedRoute, itemService, formBuilder, xlsxService, routerService, produtoService, funcionarioService, dateService, detailPanelService, contratos) {
          _classCallCheck(this, TecnologiaInformacaoCadastrosItemListaComponent);
        ...
        _createClass(TecnologiaInformacaoCadastrosItemListaComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.buildForm();
            this.setBreadCrumb();
          ...
          value: function onActivatedRoute() {
            ...
            this.$activatedRouteSubscription = this.activatedRoute.queryParams.subscribe(function (response) {
              ...
              if (_response.hasOwnProperty('TT_REGI_PAGI')) _this12.itemsPerPage = _response.TT_REGI_PAGI;

              _this12.getItem(_this12.getParams());
            });
          }
        }, {
          ...
          value: function onDetailPanelEmitter() {
            ...
            this.showDetailPanelSubscription = this.detailPanelService.config.subscribe(function (event) {
              _this13.showDetailPanel = event.showing;
            });
          }
        }, {
          key: "getProdutos",
          value: function getProdutos(params) {
            ...
            this.produtoService.getProdutos(_params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["finalize"])(function () {
              _this14.loadingProduto = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this14.produtos = response.body['data'];
              }
            });
          }
        }, {
          ...
          value: function getContrato(params) {
            ...
            _params.IN_STAT = '1';
            this.loadingContrato = true;
            this.contratos.getContrato(_params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["finalize"])(function () {
              _this15.loadingContrato = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this15.contrato = response.body['data'];
              }
            });
          }
        }, {
          ...
          value: function getCentroCusto(params) {
            ...
            this.loadingCcu = true;
            this.funcionarioService.getCentroCusto().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["finalize"])(function () {
              _this16.loadingCcu = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this16.centroCusto = response.body['data'];
              }
            });
          }
        }, {
          ...
          value: function getFuncionario(params) {
            ...
            this.funcionarioService.getFuncionario(params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["finalize"])(function () {
              _this17.loadingFuncionario = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this17.funcionario = response.body['data'];
              }
            });
          }
        }, {
          ...
          value: function getUsuariosSituacoes() {
            ...
            this.itemService.getUsuariosSituacoes().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["finalize"])(function () {
              return _this18.loadingSitUsuarios = false;
            })).subscribe(function (response) {
              _this18.situacoesUsuarios = response['data'];
            });
          }
        }, {
          key: "onReset",
          ...
          value: function onDetails(item) {
            ...
            this.getItensVinculados({
              ID_TECN_INFO_ITEM_REFE: item.ID_TECN_INFO_ITEM
            });
            this.loadingNavBar = true;
          ...
          value: function getItem(params) {
            ...
            this.itemService.getItem(_params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["finalize"])(function () {
              _this20.loading = false;
              _this20.loadingNavBar = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this20.item = response.body['data'];
                _this20.totalItems = response.body['total'];
          ...
          key: "getTotalItens",
          value: function getTotalItens(params) {
            var _this21 = this;
            ...
            this.itemService.getItem(_params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["finalize"])(function () {
              ...
              if (response.status === 200) {
                _this21.totalItens = response.body['data'];
          ...
          key: "getItensVinculados",
          value: function getItensVinculados(params) {
            var _this22 = this;

            this.loadingVinculo = true;
            this.noVinculo = true;
            this.itemService.getItem(params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["finalize"])(function () {
              _this22.loading = false;
              _this22.loadingVinculo = false;
            })).subscribe(function (response) {
              if (response.status === 200) {
                _this22.itensVinculados = response.body['data'];
                _this22.noVinculo = false;
              } else {
                _this22.noVinculo = true;
                _this22.itensVinculados = [];
              }
            }, function (error) {
          ...
          key: "onTermo",
          value: function onTermo(item) {
            var id = this.activatedRoute.snapshot.params.idSubModulo;
            this.route.navigate(["/tecnologia-informacao/contratos/".concat(id, "/termo-responsabilidade"), item.ID_TECN_INFO_ITEM], {
              relativeTo: this.activatedRoute
            });
          }
        }, {
          ...
          value: function onExport() {
            ...
            this.xlsxService.exportFile(listagemExport, "Controle_Itens_".concat(dataExport));
          }
        }]);
      ...
      TecnologiaInformacaoCadastrosItemListaComponent.ctorParameters = function () {
        return [{
      ...
      TecnologiaInformacaoCadastrosItemListaComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_7__["Component"])({
        selector: 'tecnologia-informacao-cadastros-item-lista',
        template: _raw_loader_lista_component_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: [_lista_component_scss__WEBPACK_IMPORTED_MODULE_2__["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"], src_app_shared_services_core_pnotify_service__WEBPACK_IMPORTED_MODULE_10__["PNotifyService"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"], _services_item_service__WEBPACK_IMPORTED_MODULE_11__["TecnologiaInformacaoCadastroItemService"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormBuilder"], src_app_shared_modules_xlsx_xlsx_service__WEBPACK_IMPORTED_MODULE_15__["XlsxService"], src_app_shared_services_core_router_service__WEBPACK_IMPORTED_MODULE_12__["RouterService"], _estoque_produtos_services_produtos_service__WEBPACK_IMPORTED_MODULE_3__["TecnologiaInformacaoEstoqueProdutosService"], _services_funcionarios_service__WEBPACK_IMPORTED_MODULE_5__["TecnologiaInformacaoFuncionariosService"], src_app_shared_services_core_date_service__WEBPACK_IMPORTED_MODULE_14__["DateService"], _shared_templates_detail_panel_detal_panel_service__WEBPACK_IMPORTED_MODULE_4__["DetailPanelService"], _contrato_services_contrato_service__WEBPACK_IMPORTED_MODULE_6__["TecnologiaInformacaoCadastroContratoService"]])], TecnologiaInformacaoCadastrosItemListaComponent);
      /***/
    },
