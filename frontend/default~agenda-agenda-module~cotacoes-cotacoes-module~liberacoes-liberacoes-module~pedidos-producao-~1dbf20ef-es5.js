    ...
    function uuri(module, __webpack_exports__, __webpack_require__) {
      ...
      var ComercialCicloVendasCotacoesService = /*#__PURE__*/function () {
        ...
        _createClass(ComercialCicloVendasCotacoesService, [{
          ...
          key: "getCierreOferta",
          value: function getCierreOferta() {
            return this.http.get("".concat(this.API, "/cierre")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(2));
          }
        }, {
          key: "finalizarOferta",
          value: function finalizarOferta(data) {
            return this.http.post("".concat(this.API, "/post_cierre"), data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(2));
          }
        }]);
