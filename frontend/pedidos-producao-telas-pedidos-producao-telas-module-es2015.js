...
ComercialCicloVendasPedidosProducaoTelasFormularioCarrinhoComponent.propDecorators = {
    ...
    id_cliente: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__["Input"], args: ['id_tipo_cliente',] }],
    id_departamento: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__["Input"], args: ['id_departamento',] }],
