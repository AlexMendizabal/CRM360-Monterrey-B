...
class ResponsavelController{
    ...
    public function getResponsavel(Connection $connection, Request $request):JsonResponse
    {
        try {
            ...
            $id                     = $request->query->get("ID_LOGI_ENMA_FHNC_OCRE");
     ...
     * @return JsonResponse
     */
    public function postResponsavel(Request $request, Connection $connection){
        try {
            
            $data           = json_decode($request->getContent());

            $id                     = isset($data->ID_LOGI_ENMA_FHNC_OCRE)  ? $data->ID_LOGI_ENMA_FHNC_OCRE     : '';
