...
class TipoController
{
    ...
    /**
     * @Route("/logistica/entrada-materiais/ficha-nao-conformidade/tipo", methods={"GET"})
     *
     * @param Connection $connection
     * @param Request $request
     * @return JsonResponse
     */
    public function getTipo(Connection $connection, Request $request):JsonResponse
    {
        try {

            $id                     = $request->query->get("ID_LOGI_ENMA_FHNC_TIPO");
            $nome                   = $request->query->get("NM_TIPO");
            ...
            $query = <<<SQL
                EXECUTE PRC_LOGI_ENMA_FHNC_TIPO
                     @PARAMETRO                = 2
    ...
    /**
     * @Route("/logistica/entrada-materiais/ficha-nao-conformidade/tipo", methods={"POST", "PUT"})
     *
     * @param Connection $connection
     * @param Request $request
     * @return JsonResponse
    ...
    public function postTipo(Request $request, Connection $connection)
    {
        try {
            ...
            $id             = isset($data->ID_LOGI_ENMA_FHNC_TIPO) ? $data->ID_LOGI_ENMA_FHNC_TIPO    : '';
            $nome           = isset($data->NM_TIPO)                ? $data->NM_TIPO                   : '';
